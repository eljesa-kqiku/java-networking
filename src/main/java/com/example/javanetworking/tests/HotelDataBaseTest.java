...
public class HotelDataBaseTest {
    public static void main(String[] args) {
        ...
        ArrayList<Room> availableRooms = db.getAvailableRooms(new Date(2024, 2, 2), new Date(2024, 2, 2));

        for (int i = 1; i <= 38; i++) {
            db.createReservation("John", "Doe", availableRooms.get(i).getId(), new Date(2024, 2, 2), new Date(2024, 2, 3));
        }

        ArrayList<Room> availableRooms2 = db.getAvailableRooms(new Date(2024, 2, 2), new Date(2024, 2, 3));
