...
//        users.removeIf(existing_user -> existing_user.getIpAddress() == user.getIpAddress());
    ...
    public void sendMessage(String senderName, String receiverName, String content) throws Exception {
...
//            if(ch.getDisplayName() == receiverName){
//                clientHandler = ch;
//                break;
//            }
//        }
...
//            clientHandler.receiveMessage(senderName, content);
    }
